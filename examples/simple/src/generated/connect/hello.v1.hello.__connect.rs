...
/// Static [`Spec`](::connectrpc::Spec) for the `SayHello` RPC, as seen by the server; the generated client passes it with [`origin`](::connectrpc::Spec::origin) `Client` (compare across sides with [`Spec::same_method`](::connectrpc::Spec::same_method)).
...
pub trait GreeterService: Send + Sync + 'static {
    ...
    fn say_hello<'a>(
        ...
        request: ::connectrpc::ServiceRequest<'_, crate::proto::hello::v1::HelloRequest>,
                        ...
                        format|
                    {
                        ...
                        async move {
                            let sreq = ::connectrpc::ServiceRequest::<
                                crate::proto::hello::v1::HelloRequest,
                            >::from_parts(req.reborrow(), req.bytes());
                            svc.say_hello(ctx, sreq)
                                .await?
        ...
        match method {
            "SayHello" => {
                ...
                Box::pin(async move {
                    ...
                    let req: crate::proto::hello::v1::__buffa::view::HelloRequestView<
                        '_,
    ...
    <T::ResponseBody as ::connectrpc::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    > {
        ::connectrpc::client::call_unary(
                &self.transport,
                &self.config,
                GREETER_SERVICE_SAY_HELLO_SPEC
